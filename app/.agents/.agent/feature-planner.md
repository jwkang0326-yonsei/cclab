...
Before proceeding, explicitly ask the user in the chat to review and approve the proposed plan.
...
Do not create the plan document or begin implementation until the user clearly approves.
